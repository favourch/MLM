...
//print_r($_POST);exit;
	...
	$setfld .= ", required_placement='".$_POST[placement]."'";
...
$objCore->smarty->assign(array("GetDetails_Qry" => $GetDetails_Qry, "displayMsg" => $displayMsg,"Affiliate"=>$Affiliate, "HTTP_PATH"=>HTTP_PATH,"GENDER"=>$GENDER,"NATIONALITY"=>$NATIONALITY,"GetAffiliate_name_Qry"=>$GetAffiliate_name_Qry,"account_status"=>$account_status,"PLACEMENT"=>$PLACEMENT,));
