...
$objCore->smarty->assign(array("GetUser_Qry" => $GetUser_Qry, "displayMsg" => $displayMsg,"GetPlan_Qry"=>$GetPlan_Qry, "HTTP_PATH"=>HTTP_PATH,"GENDER"=>$GENDER ,"NATIONALITY"=>$NATIONALITY));
