...
$objCore->smarty->assign(array("GetUser_Qry" => $GetUser_Qry, "displayMsg" => $displayMsg,"ImageFile"=>$ImageFile, "HTTP_PATH"=>HTTP_PATH,"EMP_STATUS"=>$EMP_STATUS,"PROJECT_STATUS"=>$PROJECT_STATUS,"GENDER"=>$GENDER ,"NATIONALITY"=>$NATIONALITY,"MONTH_ARRAY"=>$MONTH_ARRAY));
