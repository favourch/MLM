 ...
 */ 
	...
	$userID 		= $user_id;							// place your registered userID or md5(userID) here (user1, user7, ko43DC, etc).
	...
	$amountUSD		= $_SESSION['converted_amount'];							// price per membership - 79 USD
	...
	if ($box->is_paid())
	{
		...
		if (!$box->is_processed())
		{
			...
			$message = "<h1>Do not refresh the page . It will automatically redirects if the payment is processed</h1>";	
...
<div align='center'>
<br>
<h2>Do not refresh the page . It will automatically redirects if the payment is processed.</h2>
<h1>Depositing the Amount</h1><!-- Awaiting Payment -->
	...
	<?php echo $box->display_cryptobox(false, 540, 230, "padding:3px 6px;margin:10px;border:10px solid #f7f5f2;"); ?>
