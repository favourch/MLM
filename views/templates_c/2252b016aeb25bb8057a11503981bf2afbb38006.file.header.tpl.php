<?php /* Smarty version Smarty-3.1.16, created on 2017-09-07 14:41:02
         compiled from "\xampp\htdocs\MLM\\views\templates\backend\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1844759b10922c0cf99-77010392%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2252b016aeb25bb8057a11503981bf2afbb38006' => 
    array (
      0 => '\\xampp\\htdocs\\MLM\\\\views\\templates\\backend\\header.tpl',
      1 => 1504788061,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1844759b10922c0cf99-77010392',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_59b10922c34095_68910075',
  'variables' => 
  array (
    'DOMAIN_NAME' => 0,
    'HTTP_PATH' => 0,
...
<?php if ($_valid && !is_callable('content_59b10922c34095_68910075')) {function content_59b10922c34095_68910075($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <?php if ($_smarty_tpl->tpl_vars['admin_id']->value=='admin') {?>
                <ul class="nav side-menu">
                      ...
                      <li><a class="ajax-link" href="user_registration.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><span>User Registration</span></a></li>
                       <li><a class="ajax-link" href="admin_direct_referal.php"><i class="fa fa-plug" aria-hidden="true"></i><span>Direct Referal</span></a></li>
                        <li><a class="ajax-link" href="roi_setting.php"><i class="fa fa-wpforms" aria-hidden="true"></i><span>ROI Setting</span></a></li>
                        <li><a class="ajax-link" href="admin_binary_match.php"><i class="fa fa-connectdevelop" aria-hidden="true"></i><span>Binary Match</span></a></li>
                        <li><a class="ajax-link" href="admin_roi_report.php"><i class="fa fa-money"></i></i><span>ROI Report</span></a></li>
                         <li><a class="ajax-link" href="admin_bonus_report.php"><i class="fa fa-print" aria-hidden="true"></i><span>Bonus Report</span></a></li>
