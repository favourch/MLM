...
<div class="right_col" role="main"  style="width: 80%;
    height: 100%;
    border: thin solid black;
    overflow-x: hidden;
    overflow-y: hidden;padding-left:90px;">

 

<div class="tree" id="binary_tree" >
...
function exTree(parent_id){
    //alert("hi");die;
    $.ajax({
        type: "GET",
        url: "ajax-common.php?existing_check=binaryExpand&parent_id="+parent_id,
