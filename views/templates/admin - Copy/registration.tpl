...
<div class="row">
    <div class="col-md-8  col-md-offset-2 " style="background:rgba(0,0,0,.7); border-radius:10px; margin-top:30px; padding-top:20px; padding-bottom:30px; padding-left:0; padding-right:0">
      ...
      <h1 style="color:#FFF"> {if $MAilCheck eq 'Mail'}Please Check Your Email and Verify Your Mobile Number {else} SIGN IN NOW {/if}</h1>
       <h1 style="color:#FFF"></h1>
    </div>
        <div class="x_content" >
          <br />
          {if $MAilCheck neq 'Mail'}
          <form method="post"  id="reg-form" class="form-horizontal form-label-left" style="color:#FFF">
              ...
              <div class="form-group "  {if $woref eq 'Direct_Company'} style ="display:none" {/if}>
               ...
               <div class="form-group "   {if $woref eq 'Direct_Company'} style ="display:none" {/if}>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="placement_id" class="date-picker form-control col-md-7 col-xs-12" value="{$placement_name}" readonly type="text">
                  </div>
                </div>
                
                <input type="text" hidden value ="{$PLACEMENT}" name="placement"/>
                <!--div class="form-group">
