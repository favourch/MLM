                   ...
                   <form action="" method="post" id="newsForm" name="newsForm" enctype="multipart/form-data">
                          ...
                          <!-- <div class="form-group  col-md-4">
                           ...
                           <div class="form-group  col-md-4">
                                ...
                                <input type="email" class="form-control" name="email" required="required"  readonly="readonly" id="email" value="{$GetDetails_Qry.email}">
                           </div>
                           ...
                           <div class="form-group  col-md-4">
                                <label for="exampleInputEmail1">Postal Code </label>
                                 <select class="form-control" name="placement" required="required">
                                    ...
                                    {html_options options=$PLACEMENT selected={$GetDetails_Qry.required_placement}}
                                </select>
                           </div>
